...
Class  WordCloudBlock{
	...
	public function filter_settings( $value, $name ){
		...
		$option['shrink-to-fit']= true;
		$option['clear-canvas']= true;
		...
		if ( function_exists( 'lazyblocks' ) ) :
			...
			lazyblocks()->add_block( array(
				...
				'controls' => array(
					...
					'control_6969a372gd' => array(
						'type' => 'range',
						'name' => 'min-alpha',
						'default' => '0.3',
						'label' => 'Min. Transparenz',
						'help' => '',
						'child_of' => '',
						'placement' => 'inspector',
						'width' => '100',
					...
					'control_5454a642gf' => array(
						'type' => 'range',
						'name' => 'max-rotation',
						'default' => '1.6',
						'label' => 'Rotationsfaktor',
						'help' => '',
						'child_of' => '',
						'placement' => 'inspector',
						'width' => '100',
